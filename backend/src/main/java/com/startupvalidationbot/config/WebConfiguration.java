...
import com.startupvalidationbot.dealworkspace.PrivateDealAuthInterceptor;

@Configuration
public class WebConfiguration implements WebMvcConfigurer {
    private final String[] allowedOrigins;
    private final RadarAuthInterceptor radarAuthInterceptor;
    private final PrivateDealAuthInterceptor privateDealAuthInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(privateDealAuthInterceptor)
                .addPathPatterns("/api/deals/**", "/api/deal-workspaces/**");
    }
}
